...
## Project Description
This project is a Mashup Generator implemented using Python and Flask.
...
- Merges all audio clips into a single mashup file
...
## How to Run (CLI)
python 102317022.py "Singer Name" 20 25 mashup.mp3
